...
const SPECIALTIES = [
  {
    title: "Meta & Business",
    text: "توثيق وإدارة حلول الأعمال على منصات Meta.",
  },
  {
    title: "WhatsApp Solutions",
    text: "حلول WhatsApp Business وواجهات API والتكاملات.",
  },
  {
    title: "Development & Integration",
    text: "تطوير الأنظمة وربط الخدمات والمنصات معًا.",
  },
  {
    title: "Technical Support",
    text: "متابعة ودعم تقني لضمان استمرارية الحلول.",
  },
];
...
فريق Viowfy هو فريق متخصص في الحلول الرقمية والتقنية، نعمل معًا لمساعدة الأنشطة التجارية على بناء حضور رقمي أقوى والاستفادة من منظومة WhatsApp.
              </p>
              <Link
                href="/#services"
        ...
        <section className="px-6 py-20">
          <div className="mx-auto max-w-4xl">
            <h2 className="text-2xl font-bold text-[#0a1f5c]">تخصصاتنا</h2>
            <div className="mt-10 grid gap-6 sm:grid-cols-2">
              {SPECIALTIES.map((s) => (
                <div
                  key={s.title}
                  className="rounded-2xl border border-[#dbe5f5] bg-[#f3f7fd] p-6 transition hover:border-[#0b63e5]/40"
                >
                  <span className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-[#3eead0]/20 text-[#0b63e5]">
                    <span className="h-2 w-2 rounded-full bg-[#3eead0]" />
                  </span>
                  <h3 className="mt-4 font-semibold text-[#0a1f5c]">
                    {s.title}
                  </h3>
        ...
        <section className="bg-[#f3f7fd] px-6 py-20">
          <div className="mx-auto max-w-3xl text-center">
            <h2 className="text-2xl font-bold text-[#0a1f5c]">فريقنا</h2>
            <p className="mt-5 text-base leading-loose text-slate-600">
              لسنا شخصًا واحدًا يقدم كل شيء، بل فريق من المتخصصين يعملون
              كفريق واحد. في Viowfy، يجمعنا هدف واحد: تقديم حلول رقمية
              وتقنية متكاملة تساعد الأنشطة التجارية على الاستفادة من Meta
              وWhatsApp وبناء حضور رقمي أكثر احترافية.
            </p>
            <p className="mt-4 text-base leading-loose text-slate-600">
              يتولى كل فرد في فريقنا مجالًا متخصصًا، لنجمع بين الخبرة
              التقنية والتنفيذ والمتابعة في خدمة واحدة متكاملة.
            </p>
          </div>
        </section>
        ...
        <section className="bg-[#f3f7fd] px-6 py-20">
          <div className="mx-auto max-w-4xl">
            <h2 className="text-2xl font-bold text-[#0a1f5c]"> وش يميزنا</h2>
